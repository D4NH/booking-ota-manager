...
<template>
    <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div
                class="bg-mist-850 border border-mist-800 p-4 rounded-md flex flex-col justify-between">
            ...
            <div
                class="lg:col-span-2 bg-mist-850 border border-mist-800 p-4 rounded-md flex flex-col justify-between">
